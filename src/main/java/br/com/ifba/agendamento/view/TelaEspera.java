...
public class TelaEspera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("VOCE FOI POSTA NA FILA DE ESPERA");

        jLabel2.setText("Pela falta de agendamento,voce direcionada pra fila de espera, e ,");

        jLabel3.setText("tera preferencia assim que novos horarios ficarem disponiveis.");
